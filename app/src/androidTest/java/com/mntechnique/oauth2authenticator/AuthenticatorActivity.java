                    ...
                    new AsyncTask<String, Void, Intent>() {
                        ...
                        protected Intent doInBackground(String... params) {
                            ...
                            try {
                                ...
                                authtoken = AccountGeneral.sServerAuthenticate.userSignIn(TOKEN_URL, authMethod, CLIENT_ID, REDIRECT_URI);
                                authToken = authtoken;
                                JSONObject bearerToken = new JSONObject(authtoken);
                                JSONObject openIDProfile = AccountGeneral.sServerAuthenticate.getOpenIDProfile(bearerToken.get("access_token").toString(),OPENID_PROFILE_URL);
